...
export default async function HomePage({ params }: HomePageProps) {
  ...
  const slides = cmsSlides.length > 0 ? cmsSlides.map((s: any) => {
    ...
    { image: "/images/hampi-ruins.jpg", sub: "LOST KINGDOMS", title: "Hampi: Ruins of an Ancient Empire", desc: "Step back in time among bouldered landscapes, royal pavilions, and monolithic stone carvings.", location: "UNESCO Ruins, Hampi", objectPosition: "center 30%", cta1Text: "Heritage Tours", cta1Link: "/packages", cta2Text: "Inquire Now", cta2Link: "/contact" },
    ...
    { image: "/images/jaisalmer.jpg", sub: "DESERT SAFARIS", title: "The Golden Desert of Jaisalmer", desc: "Ride camels through golden sand dunes and explore the living fortress of the Thar Desert.", location: "Thar Desert, Jaisalmer", objectPosition: "center 30%", cta1Text: "Desert Tours", cta1Link: "/packages", cta2Text: "Inquire Now", cta2Link: "/contact" },
    { image: "/images/bikaner.jpg", sub: "RAJASTHAN SECRETS", title: "Bikaner: Red Sandstone Palaces", desc: "Discover the massive Junagarh Fort and the exquisite heritage architectural designs of Rajasthan.", location: "Junagarh Palace, Bikaner", objectPosition: "center 30%", cta1Text: "Explore Bikaner", cta1Link: "/destinations/rajasthan", cta2Text: "Inquire Now", cta2Link: "/contact" },
    { image: "/images/kovalam.jpg", sub: "WELLNESS RETREATS", title: "Kovalam Beach: Paradise Found", desc: "Sunbathe under the red-and-white lighthouse and enjoy Ayurvedic wellness therapies.", location: "Kovalam Beach, Kerala", objectPosition: "center 30%", cta1Text: "Kerala Wellness", cta1Link: "/destinations/kerala", cta2Text: "Inquire Now", cta2Link: "/contact" },
    ...
    { image: "/images/uttarakhand.jpg", sub: "MOUNTAIN MAJESTY", title: "Uttarakhand: Majesty of the Himalayas", desc: "Experience spectacular snow-capped peaks, meditation ashrams, and sacred rivers in the North.", location: "Himalayan Foothills, Rishikesh", objectPosition: "center 30%", cta1Text: "Himalayan Guides", cta1Link: "/destinations/uttarakhand", cta2Text: "Inquire Now", cta2Link: "/contact" },
