          ...
          <Reveal className="prose prose-lg max-w-none text-foreground/75 leading-relaxed space-y-8">
            {body ? (
              ...
              <>
                ...
                <p className="text-[15px]">For questions about this privacy policy, contact us at {contactDetails.email || "mhindiatrips@gmail.com"} or {contactDetails.phone || "+91 9782001006"}.</p>
              </>
            )}
          </Reveal>
        </div>
