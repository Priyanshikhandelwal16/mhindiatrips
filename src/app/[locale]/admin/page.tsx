      ...
      <aside className="w-64 bg-[#1A1E1D] text-white shrink-0 hidden md:flex flex-col justify-between py-6 px-5 border-r border-white/5 fixed left-0 top-0 bottom-0 z-40 overflow-y-auto">
        <div className="space-y-6">
          ...
          <div className="space-y-1">
            ...
            <a href={`/${locale}`} target="_blank" className="flex items-center space-x-3 px-4 py-2.5 rounded-xl text-xs text-white/60 hover:text-white hover:bg-white/5 transition">
            ...
            <a href={`/${locale}/destinations`} target="_blank" className="flex items-center space-x-3 px-4 py-2.5 rounded-xl text-xs text-white/60 hover:text-white hover:bg-white/5 transition">
            ...
            <a href={`/${locale}/packages`} target="_blank" className="flex items-center space-x-3 px-4 py-2.5 rounded-xl text-xs text-white/60 hover:text-white hover:bg-white/5 transition">
              <svg className="w-4 h-4 text-gold shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" /></svg>
              <span>Tour Packages</span>
            </a>
            <a href={`/${locale}/monuments`} target="_blank" className="flex items-center space-x-3 px-4 py-2.5 rounded-xl text-xs text-white/60 hover:text-white hover:bg-white/5 transition">
              <svg className="w-4 h-4 text-gold shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
              <span>Monuments</span>
            </a>
            <a href={`/${locale}/blog`} target="_blank" className="flex items-center space-x-3 px-4 py-2.5 rounded-xl text-xs text-white/60 hover:text-white hover:bg-white/5 transition">
            ...
            <a href={`/${locale}/food`} target="_blank" className="flex items-center space-x-3 px-4 py-2.5 rounded-xl text-xs text-white/60 hover:text-white hover:bg-white/5 transition">
            ...
            <a href={`/${locale}/plan-your-trip`} target="_blank" className="flex items-center space-x-3 px-4 py-2.5 rounded-xl text-xs text-white/60 hover:text-white hover:bg-white/5 transition">
              <svg className="w-4 h-4 text-gold shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
              <span>Plan Your Trip</span>
            </a>
            <a href={`/${locale}/about`} target="_blank" className="flex items-center space-x-3 px-4 py-2.5 rounded-xl text-xs text-white/60 hover:text-white hover:bg-white/5 transition">
              <svg className="w-4 h-4 text-gold shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
              <span>About Us</span>
            </a>
            <a href={`/${locale}/contact`} target="_blank" className="flex items-center space-x-3 px-4 py-2.5 rounded-xl text-xs text-white/60 hover:text-white hover:bg-white/5 transition">
              <svg className="w-4 h-4 text-gold shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
              <span>Contact</span>
            </a>
            <a href={`/${locale}/faq`} target="_blank" className="flex items-center space-x-3 px-4 py-2.5 rounded-xl text-xs text-white/60 hover:text-white hover:bg-white/5 transition">
              <svg className="w-4 h-4 text-gold shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
              <span>FAQ</span>
            </a>
            <a href={`/${locale}/gallery`} target="_blank" className="flex items-center space-x-3 px-4 py-2.5 rounded-xl text-xs text-white/60 hover:text-white hover:bg-white/5 transition">
              <svg className="w-4 h-4 text-gold shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
              <span>Gallery</span>
            </a>
            <a href={`/${locale}/privacy`} target="_blank" className="flex items-center space-x-3 px-4 py-2.5 rounded-xl text-xs text-white/60 hover:text-white hover:bg-white/5 transition">
              <svg className="w-4 h-4 text-gold shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
              <span>Privacy Policy</span>
            </a>
            <a href={`/${locale}/terms`} target="_blank" className="flex items-center space-x-3 px-4 py-2.5 rounded-xl text-xs text-white/60 hover:text-white hover:bg-white/5 transition">
