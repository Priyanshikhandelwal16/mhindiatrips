      ...
      <section className="py-20 md:py-28 relative z-10">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          <Reveal className="lg:col-span-7 text-left space-y-6">
            ...
            {/* Quick stats board */}
            <div className="p-6 bg-white border border-beige/40 rounded-2xl grid grid-cols-1 sm:grid-cols-2 gap-6 text-xs mt-8 shadow-sm overflow-hidden">
              ...
              <div className="space-y-1">
                ...
                <span className="text-royal font-semibold text-sm leading-relaxed">{bestTimeStr}</span>
              </div>
            </div>
          </Reveal>
