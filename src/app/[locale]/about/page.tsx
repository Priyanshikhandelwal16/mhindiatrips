...
export default async function AboutPage({ params }: AboutPageProps) {
  ...
  const t: Record<string, any> = {
    en: {
      ...
      storyP1: "Led by passionate travel storytellers like Vishal and Vineet Sharma, MH India Trips crafts immersive journeys that go beyond the typical tourist trails. We are not just tour organizers; we are storytellers, cultural ambassadors, and dedicated travel specialists. Our commitment to personalized pacing, safety, and deep local insights sets us apart, redefining your journey in India.",
      storyP2: "Our role is to make the complicated parts feel effortless while keeping the experience unmistakably yours.",
