        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 lg:gap-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="flex items-center gap-4 pt-2 text-royal">
              <a href={contactDetails?.facebook || "https://www.facebook.com/"} target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full bg-royal/5 flex items-center justify-center hover:bg-gold hover:text-white text-royal transition-all duration-300 shadow-md border border-royal/10" aria-label="Facebook">
              ...
              <a href={contactDetails?.instagram || "https://www.instagram.com/"} target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full bg-royal/5 flex items-center justify-center hover:bg-gold hover:text-white text-royal transition-all duration-300 shadow-md border border-royal/10" aria-label="Instagram">
              ...
              <a href={`https://wa.me/${contactDetails?.whatsapp || "919782001006"}`} target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full bg-royal/5 flex items-center justify-center hover:bg-gold hover:text-white text-royal transition-all duration-300 shadow-md border border-royal/10" aria-label="WhatsApp">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="space-y-3.5 pt-4 border-t border-royal/10 text-sm font-semibold">
              <a href={`tel:${contactDetails?.phone || "+91 9782001006"}`} className="flex items-center gap-2.5 text-royal hover:text-gold transition-colors">
