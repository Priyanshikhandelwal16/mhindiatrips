        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 lg:gap-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="flex items-center gap-4 pt-2 text-royal">
              ...
              <a href={`https://wa.me/${contactDetails?.whatsapp || "919829989187"}`} target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full bg-royal/5 flex items-center justify-center hover:bg-gold hover:text-white text-royal transition-all duration-300 shadow-md border border-royal/10" aria-label="WhatsApp">
