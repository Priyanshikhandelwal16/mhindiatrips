...
export default function OutboundTab({
  ...
  return (
    <div className="space-y-8 animate-fade-in text-xs text-[#0A2A1E]">
      ...
      {/* Header & Controls */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-4 sm:p-6 rounded-3xl border border-[#C5A862]/20 shadow-md">
        <div>
          <h2 className="text-lg sm:text-xl font-serif font-bold text-[#0A2A1E] flex items-center gap-2">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3 w-full md:w-auto">
          <div className="relative flex-grow md:flex-grow-0 w-full sm:w-64">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2.5 rounded-full border border-gray-200 text-xs focus:outline-none focus:border-[#C5A862] w-full"
            />
          </div>
          <button
            onClick={handleCreateNew}
            className="bg-[#0A2A1E] hover:bg-[#C5A862] text-white hover:text-[#0A2A1E] text-xs font-bold uppercase tracking-wider px-5 py-3 rounded-full transition-all flex items-center gap-2 shadow-md shrink-0 cursor-pointer w-full sm:w-auto justify-center"
          >
      ...
      {editItem && (
        <form onSubmit={handleSave} className="bg-white p-4 sm:p-6 md:p-8 rounded-3xl border-2 border-[#C5A862] shadow-2xl space-y-6 sm:space-y-8 animate-fade-in">
