...
export const additionalPackages: TourPackage[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      {
        en: "Experience rural India and family life in the authentic village of Hudeel",
        es: "Conoce la India rural y familiar en el auténtico pueblo de Hudeel",
        pt: "Experimente a Índia rural e a vida familiar na autêntica aldeia de Hudeel"
      },
      {
    ...
    itinerary: [
      ...
      },
      {
        day: 3,
        title: {
          en: "Delhi to Hudeel Rural Village Journey",
          es: "Delhi – Hudeel: Por carretera",
          pt: "Deli para Hudeel"
        },
        desc: {
          en: "After breakfast, we travel by road to Hudeel (a traditional village in the Shekhawati region). Upon arrival at our family home homestay, you'll have free time to settle in. Later, visit the Karni Kot Temple, dedicated to Goddess Karni, located 1 km inside the desert. Return to explore Hudeel village and experience authentic rural life. Overnight at the homestay.",
          es: "Después del desayuno ruta hacia Hudeel (un pueblo de Shekawati). Al llegar al alojamiento, a casa de nuestros familiares, habrá tiempo libre para acomodarse. Más tarde visitaremos el templo Karni Kot (Templo dedicado a la diosa Karni la mas adorada por los Rajputs) situado a 1 km en el desierto. Al regresar visitaremos Hudeel, un típico pueblo de Rajasthan. Noche en el alojamiento.",
          pt: "Após o pequeno-almoço, viagem de carro para Hudeel (uma aldeia tradicional na região de Shekhawati). À chegada à casa da nossa família, tempo livre para se acomodar. Mais tarde, visita ao Templo Karni Kot no deserto. Regresso para explorar a aldeia de Hudeel. Noite no alojamento."
        }
      },
      {
        day: 4,
        title: {
          en: "Hudeel to Bikaner",
          es: "Hudeel – Bikaner: Por carretera",
          pt: "Hudeel para Bikaner"
        },
        desc: {
