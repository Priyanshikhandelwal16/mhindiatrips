...
console.log(`Blank/Empty Images found in OTHER 20 states: ${blanks.length}`);
if (blanks.length > 0) {
  console.log("Samples of Blank/Empty Images in OTHER 20 states:");
  console.log(blanks.slice(0, 20));
  fs.writeFileSync(path.join(process.cwd(), "scripts", "blank-images-other.json"), JSON.stringify(blanks, null, 2), "utf-8");
}
