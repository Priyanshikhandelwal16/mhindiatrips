...
// 1. STATES DATA (3-Language Support)
const statesData = [
  {
    id: "rajasthan",
    displayOrder: 1,
  ...
  },
  {
    ...
    seoDesc: { en: "Discover Gujarat: Gir Asiatic Lions, White Rann of Kutch, Statue of Unity, Somnath temple & Dwarka.", es: "Descubra Gujarat: leones asiáticos de Gir, desierto blanco de Kutch, Estatua de la Unidad y templo de Somnath.", pt: "Descubra Gujarat: leões asiáticos de Gir, deserto blanco de Kutch, Estátua da Unidade e templo de Somnath." }
  },
  {
    id: "west-bengal",
    displayOrder: 12,
...
// Read existing cities to preserve Rajasthan and existing valid data
